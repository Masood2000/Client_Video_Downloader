 ...
 */
public abstract class Hilt_VideoCompletedFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VideoCompletedFragment_GeneratedInjector) this.generatedComponent()).injectVideoCompletedFragment(UnsafeCasts.<VideoCompletedFragment>unsafeCast(this));
    }
  }
