...
public final class FragmentPlayerBinding implements ViewBinding {
  ...
  @NonNull
  public final LottieAnimationView downloadNow;

  @NonNull
  public final WebView playerView;

  private FragmentPlayerBinding(@NonNull ConstraintLayout rootView,
      @NonNull LottieAnimationView downloadNow, @NonNull WebView playerView) {
  ...
  public static FragmentPlayerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.downloadNow;
      LottieAnimationView downloadNow = ViewBindings.findChildViewById(rootView, id);
      if (downloadNow == null) {
        break missingId;
      }

      id = R.id.playerView;
      WebView playerView = ViewBindings.findChildViewById(rootView, id);
      if (playerView == null) {
        break missingId;
      }

      return new FragmentPlayerBinding((ConstraintLayout) rootView, downloadNow, playerView);
    }
