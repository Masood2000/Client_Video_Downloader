...
public final class FragmentSplashBinding implements ViewBinding {
  ...
  private FragmentSplashBinding(@NonNull ConstraintLayout rootView,
      @NonNull LottieAnimationView lottieAnimationView, @NonNull LinearProgressIndicator progress,
  ...
  public static FragmentSplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentSplashBinding((ConstraintLayout) rootView, lottieAnimationView, progress,
          splashTitle);
    }
