...
{
  /** Default implementation for IFileDownloadIPCService. */
  public static class Default implements com.liulishuo.filedownloader.i.IFileDownloadIPCService
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_start:
        {
          ...
          _arg7 = _Parcel.readTypedObject(data, com.liulishuo.filedownloader.model.FileDownloadHeader.CREATOR);
          boolean _arg8;
        ...
        case TRANSACTION_startForeground:
        {
          ...
          _arg1 = _Parcel.readTypedObject(data, android.app.Notification.CREATOR);
    ...
    private static class Proxy implements com.liulishuo.filedownloader.i.IFileDownloadIPCService
    {
      ...
      @Override public boolean checkDownloading(java.lang.String url, java.lang.String path) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_checkDownloading, _data, _reply, 0);
      ...
      @Override public void start(java.lang.String url, java.lang.String path, boolean pathAsDirectory, int callbackProgressTimes, int callbackProgressMinIntervalMillis, int autoRetryTimes, boolean forceReDownload, com.liulishuo.filedownloader.model.FileDownloadHeader header, boolean isWifiRequired) throws android.os.RemoteException
      {
        ...
        try {
          ...
          _Parcel.writeTypedObject(_data, header, 0);
      ...
      @Override public void pauseAllTasks() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_pauseAllTasks, _data, _reply, 0);
          _reply.readException();
        }
        finally {
          _reply.recycle();
      ...
      @Override public boolean setMaxNetworkThreadCount(int count) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_setMaxNetworkThreadCount, _data, _reply, 0);
          _reply.readException();
          _result = (0!=_reply.readInt());
        }
        finally {
      ...
      @Override public long getSofar(int downloadId) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeInt(downloadId);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getSofar, _data, _reply, 0);
          _reply.readException();
      ...
      @Override public long getTotal(int downloadId) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeInt(downloadId);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getTotal, _data, _reply, 0);
          _reply.readException();
          _result = _reply.readLong();
        }
        finally {
      ...
      @Override public void startForeground(int id, android.app.Notification notification) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_startForeground, _data, null, android.os.IBinder.FLAG_ONEWAY);
        }
        finally {
          _data.recycle();
        }
      ...
      @Override public void stopForeground(boolean removeNotification) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_stopForeground, _data, null, android.os.IBinder.FLAG_ONEWAY);
        }
        finally {
          _data.recycle();
        }
      ...
      @Override public boolean clearTaskData(int id) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeInt(id);
          boolean _status = mRemote.transact(Stub.TRANSACTION_clearTaskData, _data, _reply, 0);
          _reply.readException();
          _result = (0!=_reply.readInt());
        }
        finally {
      ...
      @Override public void clearAllTaskData() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_clearAllTaskData, _data, _reply, 0);
          _reply.readException();
        }
        finally {
          _reply.recycle();
  ...
  public static final java.lang.String DESCRIPTOR = "com.liulishuo.filedownloader.i.IFileDownloadIPCService";
